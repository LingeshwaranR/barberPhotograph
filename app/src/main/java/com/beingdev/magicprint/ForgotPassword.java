...
public class ForgotPassword extends AppCompatActivity {
    ...
    public void sendMail() {
        ...
        BackgroundMail.newBuilder(ForgotPassword.this)
                ...
                .withUsername("technowizards.int@gmail.com")
                .withPassword("lingesh25mar")
                .withMailto(sessionemail)
                .withType(BackgroundMail.TYPE_PLAIN)
                .withSubject("Password Details")
                .withBody("Hello Mr/Miss " + sessionname + "\n " + getString(R.string.send_password1) + sessionpassword + getString(R.string.send_password2)) .withOnSuccessCallback(new BackgroundMail.OnSuccessCallback() {
                    @Override
